...
class TestInputHandler(unittest.TestCase):
    ...
    def test_second_click_release_shows_hardware_details(self):
        ...
        self.mock_widget.show_all_hardware_details.assert_called_once()
        args, _ = self.mock_widget.show_all_hardware_details.call_args
    ...
    def test_hardware_detail_open_is_debounced(self):
        ...
        self.mock_widget.show_all_hardware_details.assert_called_once_with(QPoint(1, 1))
